...
// Fixed Social Icons Components with default props
...
export default function Home() {
  ...
  // Memoize handleArtFormSelect to fix useEffect dependency warning
  const handleArtFormSelect = useCallback((index: number) => {
  ...
  }, [selectedArtForm, artForms.length, handleArtFormSelect])
      ...
      <main className="min-h-screen bg-cream">
        ...
        >
          <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Dynamic Featured Artwork - Fixed Next.js Image */}
            <div className="mb-16">
              <div className="relative max-w-4xl mx-auto">
                <div className="aspect-[4/3] bg-stone/30 rounded-sm overflow-hidden relative">
                  <Image
